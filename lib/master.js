                                ...
                                if (regs.config[n].formula) {
                                    ...
                                    try {
                                        ...
                                        if (scaleAddress !== null && !isNaN(scaleAddress)) {
                                            adapter.log.warn(`[${prefixAddr}] Calculation of a scaleFactor which is based on another scaleFactor seems strange. Please check the config for adress ${regs.config[n].address} !`);
                                        }
