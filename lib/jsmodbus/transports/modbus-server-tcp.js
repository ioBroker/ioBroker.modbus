...
module.exports = stampit()
    ...
    .init(function () {
        ...
        let init = () => {
            ...
            server.listen(this.options.tcp.port, this.options.tcp.hostname, err => {
                if (err) {
            ...
            this.log.debug('server is listening on port', this.options.tcp.hostname + ':' + this.options.tcp.port);
