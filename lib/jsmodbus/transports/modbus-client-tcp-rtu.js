                ...
                if (buffer[1] === 5 || buffer[1] === 6 || buffer[1] === 15 || buffer[1] === 16) {
                    ...
                    if (buffer[1] & 0x80) {
                        ...
                        if (buffer[2] && ERROR_CODES[buffer[2]]) {
                            this.log.error(`Error response for FCx${buffer[1] & 0xF}: ${ERROR_CODES[buffer[2]].name}`);
                        ...
                        this.log.error(`unknown function code: 0x${buffer[1].toString(16)}, 0x${buffer[2].toString(16)}`);
                    }
