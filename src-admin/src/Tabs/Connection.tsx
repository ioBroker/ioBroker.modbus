...
const schema: ConfigItemPanel = {
    ...
    items: {
        ...
        selectBy: {
            ...
            options: [
                { value: 'port', label: 'Serial port' },
                { value: 'device', label: 'USB device ID' },
            ],
            default: 'port',
            xs: 12,
            sm: 6,
        ...
        comName: {
            ...
            type: 'selectSendTo',
            label: 'Port',
            hidden: 'data.type !== "serial" || data.selectBy === "device"',
            command: 'listUart',
            data: {},
            manual: true,
            noTranslation: true,
        ...
        comDeviceId: {
            ...
            type: 'selectSendTo',
            label: 'USB device',
            help: 'Identified by vendor and product ID, so the OS may reassign the port name',
            hidden: 'data.type !== "serial" || data.selectBy !== "device"',
            command: 'listUartDevices',
            data: {},
            manual: true,
            noTranslation: true,
            xs: 12,
